...
const uniforms = [
  { label: "Summer", url: "/assets/pdf/uniform/Summer-Uniform.pdf" },
  { label: "Winter", url: "/assets/pdf/uniform/Winter-Uniform.pdf" },
  { label: "Vendor List", url: "/assets/pdf/uniform/Vendor-List.jpg" },
];
...
export default function UniformClient() {
  return (
